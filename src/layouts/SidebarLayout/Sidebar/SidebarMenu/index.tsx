      ...
      <MenuWrapper>
        ...
        >
          <SubMenuWrapper>
            <List component="div">
              {/* <ListItem component="div">
                <NextLink href="/exception/detection" passHref>
                  <Button
                    className={
                      currentRoute === '/exception/detection' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
        ...
        >
          <SubMenuWrapper>
            <List component="div">
              <ListItem component="div">
                <NextLink href="/knowledge/graph" passHref>
                  <Button
                    className={
                      currentRoute === '/knowledge/graph' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
              ...
              {/* <ListItem component="div">
                <NextLink href="/knowledge/statistics" passHref>
                  <Button
                    className={
                      currentRoute === '/knowledge/statistics' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
        ...
        >
          <SubMenuWrapper>
            <List component="div">
              <ListItem component="div">
                <NextLink href="/datadisplay/metrics" passHref>
                  <Button
                    className={
                      currentRoute === '/datadisplay/metrics' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
              ...
              <ListItem component="div">
                <NextLink href="/datadisplay/logging" passHref>
                  <Button
                    className={
                      currentRoute === '/datadisplay/logging' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
