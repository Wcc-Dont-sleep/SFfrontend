    ...
    <BoxHighlights>
        ...
        <BoxLayoutsContent maxWidth="lg">
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              >
                {t(
                  '我们的智能运维系统使用遵循 Google Material Design 的 MUI 这一 React UI 设计框架，提供轻盈、易用、符合直觉的智能运维。'
                )}
              </TypographySubHeading>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton target="_blank" rel="noopener" href="#">
                <Typography variant="h4">{t('个人信息')}</Typography>
                <img src="/static/images/placeholders/covers/2.png" alt="OrderOverview" />
              </LayoutImgButton>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton target="_blank" rel="noopener" href="#">
                <Typography variant="h4">{t('告警信息')}</Typography>
                <img src="/static/images/placeholders/covers/3.png" alt="VIPManagement" />
              </LayoutImgButton>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton target="_blank" rel="noopener" href="#">
                <Typography variant="h4">{t('知识图谱')}</Typography>
                <img src="/static/images/placeholders/covers/4.png" alt="AddPromotion" />
              </LayoutImgButton>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton target="_blank" rel="noopener" href="#">
                <Typography variant="h4">{t('时间序列')}</Typography>
                <img src="/static/images/placeholders/covers/5.png" alt="TableManagement" />
              </LayoutImgButton>
            </Grid>
            <Grid item xs={12} md={6}>
              <LayoutImgButton target="_blank" rel="noopener" href="#">
                <Typography variant="h4">{t('日志检测')}</Typography>
                <img src="/static/images/placeholders/covers/1.png" alt="Collapsed Sidebar" />
              </LayoutImgButton>
            </Grid>
          </Grid>
        </BoxLayoutsContent>
      ...
      >
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            <Box>
              <TypographyFeature>5 大</TypographyFeature>
              <TypographyHeading
                sx={{
                  mb: 1
                }}
        ...
        >
          <Grid item md={4}>
            <Box>
              <TypographyFeature>5</TypographyFeature>
              <TypographyHeading
                sx={{
                  mb: 1
                }}
                ...
                >
                  <Card>
                    <CardActionArea>
                      <CardMedia
                        component={'img'}
                        image={'/static/images/placeholders/covers/tauri.jpg'}
                ...
                >
                  <Card>
                    <CardActionArea>
                      <CardMedia
                        component={'img'}
                        image={'/static/images/placeholders/covers/react.png'}
